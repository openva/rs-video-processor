...
class MetadataBuilderTest extends TestCase
{
    ...
    {
        $job = new ArchiveJob(1, 'house', 'Appropriations', '2023-01-27', 'https://s3.amazonaws.com/video.richmondsunlight.com/house/committee/20230127.mp4', 'WEBVTT', null, null, null, 42, 'Courts of Justice');
        $builder = new MetadataBuilder();
        $metadata = $builder->build($job);
