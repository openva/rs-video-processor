...
echo "[1/7] Scraping and importing metadata..."
php "$SCRIPT_DIR/pipeline.php"
echo ""

# Step 2: Download videos to S3 (parallel)
echo "[2/7] Downloading videos to S3 ($FETCH_WORKERS workers)..."
pids=()
...
echo "[3/7] Generating screenshots ($SCREENSHOT_WORKERS workers)..."
pids=()
...
echo "[4/7] Processing transcripts, bills, and speakers in parallel..."
pids=()
...
echo "[5/7] Uploading to Internet Archive ($ARCHIVE_WORKERS workers)..."
pids=()
